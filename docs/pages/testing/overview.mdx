...
This work builds on the hypercore-sim by [Cain](https://x.com/cainosullivan) from [Hyperdrive](https://hyperdrive.fi/). We adopted the core action queuing system and added major changes, including support for forked testing, support for Spot/Perp trading, among many others. See the original repo here: [hypercore-sim](https://github.com/ambitlabsxyz/hypercore/tree/main/packages/hypercore-sim).
